...
{
    public partial class AttrezzatureOleodinamicheAREAGHIContext : DbContext
    {
        public AttrezzatureOleodinamicheAREAGHIContext()
        {
        }

        public AttrezzatureOleodinamicheAREAGHIContext(DbContextOptions<AttrezzatureOleodinamicheAREAGHIContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=10.3.54.6\\SQLEXPRESS;Database=AttrezzatureOleodinamicheAREACALDO;User ID=sa;Password=12345678#A");
            }
        }
