...
{
    public partial class AttrezzatureOleodinamicheAREAPGTContext : DbContext
    {
        public AttrezzatureOleodinamicheAREAPGTContext()
        {
        }

        public AttrezzatureOleodinamicheAREAPGTContext(DbContextOptions<AttrezzatureOleodinamicheAREAPGTContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=10.3.54.50;Database=AttrezzatureOleodinamiche;User ID=sa;Password=lamta");
            }
        }
